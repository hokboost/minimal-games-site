...
class PostgresRateLimitStore {
    constructor(pool, namespace) {
        ...
        this.windowMs = 60000;
        // Every store instance receives a distinct namespace and includes it in
        // the persisted key. Identical client keys in two limiter instances are
        // therefore independent. express-rate-limit must know this, otherwise it
        // mistakes stacked admin limiters for a duplicate increment on one store.
        this.localKeys = true;
    }
