...
function readStreamerWorldFlags(env = process.env) {
    ...
    return Object.freeze({
        ...
        newGamesEnabled: values.STREAMER_WORLD_ENABLED
            && values.CREATOR_PROFILE_ENABLED
            && values.STREAMER_NEW_GAMES_ENABLED,
        rewardsEnabled: values.STREAMER_WORLD_ENABLED
            && values.CREATOR_PROFILE_ENABLED
            && values.STREAMER_REWARD_CATALOG_ENABLED,
        achievementsEnabled: values.STREAMER_WORLD_ENABLED
            && values.CREATOR_PROFILE_ENABLED
            && values.STREAMER_ACHIEVEMENTS_ENABLED,
        ownerUsername
    });
}
